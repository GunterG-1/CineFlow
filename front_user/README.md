...
Descripción
-----------
Aplicación React que consume el BFF/Gateway y presenta la experiencia de usuario.
...
El frontend corre por defecto en `http://localhost:3000` y hace requests al gateway (`http://localhost:8080`).
