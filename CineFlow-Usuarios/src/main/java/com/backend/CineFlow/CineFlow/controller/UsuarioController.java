...
public class UsuarioController {
    ...
    // GET: Obtener estadisticas del panel admin
    @GetMapping("/estadisticas")
    @Operation(summary = "Estadisticas de usuarios", description = "Devuelve totales de usuarios, admins y usuarios con metodo de pago.")
