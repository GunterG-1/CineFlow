...
import com.backend.CineFlow.CineFlow.dto.AlimentoDTO;
import com.backend.CineFlow.CineFlow.dto.PromotionDTO;
...
public class ConfiiteroControlador {
    ...
    @GetMapping("/items")
    @Operation(summary = "Obtener items", description = "Lista todos los items/alimentos disponibles en la confitería.")
    public ResponseEntity<List<AlimentoDTO>> obtenerItems() {
        try {
            List<AlimentoDTO> items = confiiteroServicio.obtenerAlimentos();
    ...
    @Operation(summary = "Obtener promociones", description = "Lista promociones disponibles en la confitería.")
    public ResponseEntity<List<PromotionDTO>> obtenerPromotions() {
        try {
            List<PromotionDTO> promos = confiiteroServicio.obtenerPromociones();
