...
public class ControladorEntradas {
    ...
    public ResponseEntity<Map<String, Object>> reservarAsientos(@Valid @RequestBody SolicitudReserva solicitud) {
    ...
    public ResponseEntity<Map<String, Object>> procesarPago(@Valid @RequestBody SolicitudCompra solicitud) {
    ...
    public ResponseEntity<Map<String, Object>> manejarValidacion(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.badRequest().body(Map.of("exito", false, "error", mensaje));
    }
}